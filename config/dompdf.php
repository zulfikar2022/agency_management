...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var array
         */
        'isHtml5ParserEnabled' => true, // Essential for Bengali/Complex scripts
        'isRemoteEnabled' => true,
        'isFontSubsettingEnabled' => false,

        'font_family' => [
            'Potro Sans Bangla' => [
                'normal'      => public_path('fonts/Potro Sans Bangla Regular.ttf'),
                'bold'        => public_path('fonts/Potro Sans Bangla Bold.ttf'),
            ],
        ],
