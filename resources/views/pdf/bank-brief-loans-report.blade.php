...
<head>
    ...
    <title>ঋণ প্রদানের সংক্ষিপ্ত রিপোর্ট</title>
    ...
    <body>
        ...
        <h1 class="title"> ঋণ প্রদানের সংক্ষিপ্ত রিপোর্ট</h1>
        ...
        <p style="text-align: center; font-weight: bold; margin-bottom: 20px;">মোট প্রদানকৃত ঋণ: {{ number_format($total_provided_loan / 100, 2) }} টাকা</p>

    @forelse ($loans as $loan)
         <div class="deposit-collection-entry" style="display: grid; grid-template-columns: 1fr 2fr 2fr ; gap: 10px; border-bottom: 1px solid #ccc;">
            <div>
            ...
            <div>
                <p style="font-weight: bold;">প্রদানকৃত ঋণের পরিমাণঃ </p>
               <span>{{ number_format($loan['total_amount'] / 100, 2) }} টাকা</span>
            </div>
         </div>
    @empty
       <p style="text-align: center; font-weight: bold;">কোনো ঋণ প্রদান করা হয়নি।</p>
    @endforelse
