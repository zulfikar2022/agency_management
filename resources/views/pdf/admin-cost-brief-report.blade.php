...
<head>
    ...
    <title>খরচের সংক্ষিপ্ত রিপোর্ট</title>
    ...
    <body>
        ...
        <h1 class="title"> খরচের সংক্ষিপ্ত রিপোর্ট</h1>
        ...
        @forelse ($costs as $cost)
            <div class="cost-entry">
                <div style="display: grid; grid-template-columns: 2fr 2fr 2fr; border-bottom: 1px solid #ccc;">
                   <div>
                        <p style="font-weight: bold;">এডমিনের আইডিঃ </p>
                        <span>{{ $cost['user_id'] }}</span>
                   </div>
                    <div>
                        <p style="font-weight: bold;">এডমিনের নামঃ </p>
                        <span>{{ $cost['user_name'] }}</span>
                   </div>
                     <div>
                            <p style="font-weight: bold;">মোট খরচঃ </p>
                            <span>{{ number_format($cost['total_amount'], 2) }} টাকা</span> 
                    </div>
