  ...
  return (
    <div className="mt-10 mb-5">
      <p className="text-2xl font-bold text-center my-5">
        ক্রয়কৃত পণ্যের লিস্ট
      </p>
      {purchagedProducts?.map((item, index) => {
        return (
          <div
            key={item?.id}
            className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 border-b px-5 py-2 container mx-auto"
          >
            <div className="">
            ...
            <div className="">
              <p className="font-bold">সাপ্তাহিক কিস্তিঃ </p>
              <p>{item?.weekly_payable_price}</p>
            </div>
            <div className="">
