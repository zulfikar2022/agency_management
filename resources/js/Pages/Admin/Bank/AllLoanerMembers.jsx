...
function AllLoanerMembers({ data }) {
  ...
  return (
    <LayoutForMoney>
      <Head title="সকল ঋণগ্রহীতা সদস্য" />
      <div className="container mx-auto">
        <h2 className="font-bold text-3xl text-center my-4">
          {' '}
          সকল ঋণগ্রহীতা সদস্য দেখুন{' '}
        </h2>
        <div className="flex flex-col md:flex-row mb-4 mr-3 md:mr-0 px-2">
          ...
          <Link
            href={route('admin.bank.all_loan_members', {
              search: searchTerm,
            })}
...
export default AllLoanerMembers;
