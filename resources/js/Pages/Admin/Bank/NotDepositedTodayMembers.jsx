...
function NotDepositedTodayMembers({ data }) {
  ...
  return (
    <LayoutForMoney>
      <Head title="আজ সঞ্চয় জমা দেয়নি এমন সদস্যগণ" />
      <div className="container mx-auto">
        <h2 className="font-bold text-3xl text-center my-4">
          {' '}
          আজ সঞ্চয় জমা দেয়নি এমন সদস্যগণ দেখুন{' '}
        </h2>
        <div className="flex flex-col md:flex-row mb-4 mr-3 md:mr-0 px-2">
          ...
          <Link
            href={route('admin.bank.not_deposited_today', {
              search: searchTerm,
            })}
...
export default NotDepositedTodayMembers;
