...
function UpdateProduct({ product }) {
  ...
  const { data, setData, put, processing, errors, reset } = useForm({
    ...
    price_per_product: product.buying_price_per_product,
  });
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title text-2xl">নতুন আপডেট করুন</h2>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-medium">
                      বর্তমান পরিমাণ <span className="text-error">*</span>
                    </span>
                  </label>
                  <input
                    type="number"
                    min="0"
                    step={1}
                    className={`input input-bordered w-full ${errors.current_quantity ? 'input-error' : ''}`}
                    // placeholder="50"
